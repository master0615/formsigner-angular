...
@Component({
	selector: 'app-templates-view-content',
	templateUrl: './content.component.html',
	styleUrls: ['./content.component.scss'],
	encapsulation: ViewEncapsulation.None
})
export class TemplatesViewContentComponent implements OnInit {

	@Input() templateForm: TemplateForm;

	isDataLoaded = false;
	imgLoadedCount:number = 0;
	@ViewChild('templates-view-content') viewContentEl:ElementRef;
	...
	getImageData(event, file:TemplateFormFile) {
		//this.pdfGen.convertDomToImage(this.temp);
